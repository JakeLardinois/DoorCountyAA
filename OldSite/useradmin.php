...
?>
	...
	<tr>
		...
		<td align="right" valign="bottom"><span class="user_list_options">[ <a href="useradmin.php?flag=add"><?php echo $lang['adduser']?></a> | <a href="events.php"><?php echo $lang['return']?></a> ]</span></td>
	</tr>
...
?>
	...
	<tr>
		...
		&nbsp;	<input type="button" value="<?php echo $lang['cancel']?>" onClick="location.replace('events.php');">
		</td>
	</tr>
	</table>
	</form>
...
?>
	...
	<p>
	<span class="user_list_options">[ <a href="events.php"><?php echo $lang['return']?></a> ]</span>
	
<?php
	} else {
		echo $lang['accessdenied'] . "<p>";
		echo "<span class=\"user_list_options\">[ <a href=\"events.php\">" . $lang['return'] . "</a> ]</span>";
	}
?>
	</body>
	</html>
