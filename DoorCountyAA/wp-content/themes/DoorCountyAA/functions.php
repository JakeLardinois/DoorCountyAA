...
function tribe_alter_event_archive_titles ( $original_recipe_title, $depth ) {
	...
	$title_upcoming =   'Upcoming Meetings'; // List View: Upcoming events
	$title_past =       'Past Meetings'; // List view: Past events
	$title_range =      'Meetings for %1$s - %2$s'; // List view: range of dates being viewed
	$title_month =      'Meetings for %1$s'; // Month View, %1$s = the name of the month
	$title_day =        'Meetings for %1$s'; // Day View, %1$s = the day
	$title_all =        'All meetings for %s'; // showing all recurrences of an event, %s = event title
	$title_week =       'Meetings for week of %s'; // Week view
